  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center space-x-4">
      ...
      <div
        ...
        class="relative flex h-20 w-20 cursor-pointer items-center justify-center overflow-hidden rounded-full border-2 border-dashed border-gray-300 bg-gray-50 transition-colors hover:border-gray-400"
        :class="{
      ...
      >
        ...
        <div v-if="!previewUrl" class="text-center">
          <UserIcon class="mx-auto mb-1 h-8 w-8 text-gray-400" />
      ...
      <div class="flex flex-col space-y-2">
        <button
          ...
          class="rounded-md border border-gray-300 px-3 py-1.5 text-sm transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
          ...
          {{
            uploading
              ...
              : previewUrl
                ...
                : t("components.avatarUpload.select")
          }}
        </button>
        ...
        <button
          ...
          @click="removeAvatar"
          :disabled="disabled || uploading"
          class="rounded-md border border-red-300 px-3 py-1.5 text-sm text-red-600 transition-colors hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
          ...
          reject(
            new Error(
              errorResponse.message ||
                t("components.avatarUpload.error.upload", { status: xhr.status })
            )
          );
        } catch {
...
const processFile = async (file: File) => {
  ...
  try {
    ...
    const errorMessage =
      err instanceof Error ? err.message : t("components.avatarUpload.error.generic");
