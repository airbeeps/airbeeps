    ...
    columns: [
      {
        ...
        cell: (ctx) => {
          const title =
            (ctx.getValue() as string) || t("admin.pages.conversations.untitledConversation");
          return h(
            "div",
            {
...
<template>
  ...
  <ConversationMessagesDialog
    ...
    :conversation-title="
      selectedConversation?.title || t('admin.pages.conversations.untitledConversation')
    "
