...
import { ArrowLeft, Save, X, ChevronDown, ChevronUp, Info } from "lucide-vue-next";
...
// Inheritance toggles + override values
  ...
  <div class="space-y-6">
    ...
    <Card class="max-w-4xl">
      <CardHeader>
        ...
        <CardDescription>
          {{
            t("admin.pages.assistants.create.formCardDescription", {
              defaultMessage: "Configure Assistant basic information and model parameters",
            })
          }}
        </CardDescription>
      </CardHeader>
              ...
              <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div class="space-y-2">
                  ...
                  <Input
                    ...
                    "
                    :disabled="loading || useGlobalGenerationDefaults"
                    min="0"
                    max="2"
                    step="0.1"
            ...
            <div class="bg-muted/30 space-y-3 rounded-md border p-4">
              ...
              <div class="space-y-2">
                ...
                <Select
                  ...
                  :disabled="loading || !followupsGlobalEnabled || !followupQuestionsEnabled"
                >
    ...
    <!-- RAG Config -->
    <div v-if="mode === 'RAG'" class="max-w-4xl space-y-4">
      <div class="flex items-center justify-between">
