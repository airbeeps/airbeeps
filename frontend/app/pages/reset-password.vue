  ...
  <div class="flex flex-col gap-6">
    ...
    >
      ...
      <p class="mt-2 text-xs">
        {{ $t("resetPassword.autoRedirect", { seconds: redirectCountdown }) }}
      </p>
    </div>
    ...
    <div v-if="!success && token" class="space-y-4">
      <div class="space-y-2">
        ...
        <input
          ...
          class="border-input bg-background focus-visible:ring-ring w-full rounded-md border px-3 py-2 text-sm shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
        />
      ...
      <Button type="button" class="w-full" :disabled="loading" @click="resetPassword">
